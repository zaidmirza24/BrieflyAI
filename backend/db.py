...
def ensure_indexes() -> None:
    ...
    db.sessions.create_index([("mentor_id", ASCENDING), ("created_at", DESCENDING)])
    db.sessions.create_index([("student_id", ASCENDING), ("created_at", DESCENDING)])
    db.sessions.create_index([("status", ASCENDING), ("created_at", DESCENDING)])
